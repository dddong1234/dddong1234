...
- OZ AI 헬스케어 부트캠프에서 머신러닝 / 딥러닝 / 웹 개발 학습 중
- 의료 데이터 기반 AI 프로젝트와 LLM 응용 프로젝트를 진행했습니다
- FastAPI 기반 API 개발 및 간단한 웹 서비스 구조를 학습하고 있습니다
...
### 1. IVF 임신 성공 예측
- 의료 데이터를 활용한 이진 분류 프로젝트
- CatBoost 기반 학습, 파생변수 생성, 클래스 불균형 처리
- SHAP을 활용한 피처 중요도 분석

### 2. 간호사 인수인계 보조 시스템
- 변화 중심 인수인계 자동 요약 MVP
- 상태 변화, 처방 변경, 검사 업데이트를 구조적으로 정리

### 3. my_ml_kit
- 머신러닝 실험 자동화 도구
- 전처리, 모델 학습, 교차검증, 성능 비교 자동화


### 4. 의료 차팅 보조 시스템
- 환자 기록을 바탕으로 요약 / SOAP / 환자 설명 생성
- OpenAI API와 Gradio를 활용한 프로토타입 구현
...
<img src="https://img.shields.io/badge/DataSpell-000000?style=for-the-badge&logo=jetbrains&logoColor=white">
...
<p align="center">
  <img
    src="https://github-profile-trophy-liard-delta.vercel.app/?username=dddong1234&theme=flat&no-frame=true&no-bg=true&row=1&column=6&margin-w=10"
    alt="GitHub Trophies"
  />
</p>
